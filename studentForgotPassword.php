...
if (!$email) {
    ...
    $sel_query = "SELECT * FROM `application_student` WHERE student_email='".$email."'";
...
$output.='<p>-------------------------------------------------------------</p>';
$output.='<p><a href="http://mytutorsbd.com/studentResetPassword.php?key='.$key.'&email='.$email.'&action=reset" target="_blank">http://mytutorsbd.com/studentResetPassword.php?key='.$key.'&email='.$email.'&action=reset</a></p>';      
$output.='<p>-------------------------------------------------------------</p>';
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Forgot Password as a Student.</h3>
						<form  method="post" action="" name="reset" >
                                <div class="row register-form">
									<div class="col-md-6">
                                        
                                      <div class="form-group">
                                            <input type="email" name="student_email" class="form-control" placeholder="Enter Your Registered Email *" maxlength="190"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required />
                                        </div>
                                    </div>
