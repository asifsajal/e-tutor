...
<p><a href="http://secure.admin.mytutorsbd.com/forgot-password.php">Click here</a> to reset password.</p>';
    }else{
...
$pass1n = md5($pass1);
mysqli_query($con,
"UPDATE `control_admin` SET `password`='".$pass1n."' WHERE `email`='".$email."';");   

mysqli_query($con,"DELETE FROM `password_reset_manager` WHERE `email`='".$email."';");     
    
echo '<div class="error"><p>Congratulations! Your password has been updated successfully. &nbsp;<a href="http://secure.admin.mytutorsbd.com/login.php">Login</a></p></div><br />';
        }       
}
?>              
