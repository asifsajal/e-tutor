...
<?php 
if (isset($_GET['approvejob'])){
$approvejobID=$_GET['approvejob'];
$approvejob = $gnc->approvejob($approvejobID);
}
?>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
						<table class="data-table stripe hover nowrap">
							...
							<tbody>
								<?php 
				                $getallUnApprovedJobs= $gnc->getallUnApprovedJobs();
				                if($getallUnApprovedJobs){
				                while($result = $getallUnApprovedJobs->fetch_assoc()){
				                ?>
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item" onclick="return confirm('Are you sure to Approve this Job Post ?')" href="?approvejob=<?php echo $result['jobId'];?>"><i class="fa fa-check"></i> Approve</a>
	...
	<?php 
    if (isset($approvejob)){
    echo '<script type="text/javascript">alert("' . $approvejob . '")</script>';
}?>							
