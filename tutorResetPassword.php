...
<p><a href="http://mytutorsbd.com/tutorForgotPassword.php">Click here</a> to reset password.</p>';
    }else{
...
$pass1n = md5($pass1);
mysqli_query($con,
"UPDATE `application_tutor` SET `tutor_password`='".$pass1n."' WHERE `tutor_email`='".$email."';");   
