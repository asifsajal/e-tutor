									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item" onclick="return confirm('Are you sure to approve this Tutor ?')" href="?approve=<?php echo $result['tutor_id'];?>"><i class="fa fa-check"></i> Approve</a>
												<a class="dropdown-item" onclick="return confirm('Are you sure to delete this Tutor ?')" href="?delt=<?php echo $result['tutor_id'];?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
...
<?php 
    if (isset($approve)){
    echo '<script type="text/javascript">alert("' . $approve . '")</script>';
}?>	
<?php 
    if (isset($delt)){
