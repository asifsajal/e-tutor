				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
						<table class="data-table stripe hover nowrap">
							...
							<tbody>
								<?php 
				                $getallappliedjobsview= $gnc->getallappliedjobsview();
				                if($getallappliedjobsview){
				                while($result = $getallappliedjobsview->fetch_assoc()){
				                ?>
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="viewJob.php?jobID=<?php echo $result['jobId'];?>" target="_blank"><i class="fa fa-eye"></i> View Jobs</a>

												<a class="dropdown-item" href="appliedTutorListForJobSingle.php?jobID=<?php echo $result['jobId'];?>" target="_blank"><i class="fa fa-eye"></i> View Applied Tutor List</a>
												...
												<a class="dropdown-item" onclick="return confirm('Are you sure to delete this Job Post ?')" href="?deljob=<?php echo $result['jobId'];?>"><i class="fa fa-trash"></i> Delete Jobs</a>
											</div>
										</div>
									</td>
								</tr>
